...
class Day2 {
    ...
    // Part 1
    public static int validPasswords(String[] input) {
        int validCount = 0;
        for (int i = 0; i < input.length; i++) {
            String currPass = input[i];
            String[] temp = currPass.split("\\s+");

            String minMax = temp[0];
            String[] minMaxTemp = minMax.split("-");
            int min = Integer.parseInt(String.valueOf(minMaxTemp[0]));
            int max = Integer.parseInt(String.valueOf(minMaxTemp[1]));

            char repeatedChar = (char)temp[1].charAt(0);
    ...
    // Part 2
    public static int validPasswordsAgain(String[] input) {
        int validCount = 0;
        for (int i = 0; i < input.length; i++) {
            String currPass = input[i];
            String[] temp = currPass.split("\\s+");
            ...
            String[] positionsTemp = positions.split("-");
            int pos1 = Integer.parseInt(String.valueOf(positionsTemp[0]));
            int pos2 = Integer.parseInt(String.valueOf(positionsTemp[1]));

            char repeatedChar = (char)temp[1].charAt(0);

            String password = temp[2];

            if (password.charAt(pos1-1) == repeatedChar && password.charAt(pos2-1) != repeatedChar || 
                password.charAt(pos1-1) != repeatedChar && password.charAt(pos2-1) == repeatedChar) {
                validCount++;
            }
        }
        return validCount;
